                ...
                <div class="id-card">
                    <div class="id-card-front">
                        ...
                        <div class="id-details">
                            ...
                            <p><span class="field-label">DOB:</span> {{ \Carbon\Carbon::parse($employee->dob)->format('d-m-Y') }}</p>
                ...
                <div class="id-card">
                    <div class="id-card-back">
                        ...
                        <div class="dates-block">
                         <p><span class="field-label">Join:</span> {{ \Carbon\Carbon::parse($employee->join_date)->format('d-m-Y') }}</p>
<p><span class="field-label">Expire:</span> {{ \Carbon\Carbon::parse($employee->expire_date)->format('d-m-Y') }}</p>
                        </div>
