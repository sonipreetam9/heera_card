                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{-- <a class="btn btn-warning btn-sm"
                                                        href="{{ route('edit.employee', ['empTag' => $emp->tag_id]) }}">Edit</a> --}}
                                                    <a class="btn btn-success btn-sm"
                                                        href="{{ route('print.employee.id.card', ['empTag' => $emp->tag_id]) }}">Card</a>
                                                    {{-- <a href="javascript:void(0);" class="btn btn-danger btn-sm delete-btn"
                                                        data-url="{{ route('delete.register.employee', ['empTag' => $emp->tag_id]) }}">
                                                        Delete
                                                    </a> --}}
